...
setwd("D:\\Documents\\LambertME_travail2012_20131107\\Volet4_Bdstructuration\\R\\Alignement")
getwd()
...
write.table(matricetest,"D:\\Documents\\LambertME_travail2012_20131107\\Volet4_Bdstructuration\\R\\Alignement\\matricetest.txt", 
            sep=";", row.names=TRUE, col.names=TRUE)#le nom des colonnes et des lignes dispara?t

write.table(matricetest,"D:\\Documents\\LambertME_travail2012_20131107\\Volet4_Bdstructuration\\R\\Alignement\\matrice1test.txt", 
            sep=";", row.names=FALSE, col.names=TRUE)#le nom des colonnes et des lignes dispara?t et on peut mettre les lignes  et pas les colonnes

write.csv2(matricetest,"D:\\Documents\\LambertME_travail2012_20131107\\Volet4_Bdstructuration\\R\\Alignement\\matrice2test.csv", row.names=TRUE)#le nom des colonnes et des lignes dispara?t et on peut mettre les lignes  et pas les colonnes
...
fix(Sequencealign)#v?rifier avec des s?quences qui ont des longueurs diff?rentes
...
write.table(matrice3K80,"D:\\Documents\\LambertME_travail2012_20131107\\Volet4_Bdstructuration\\R\\Alignement\\matrice3k80.txt", sep="\t")
...
write.fasta(align,"D:\\Documents\\LambertME_travail2012_20131107\\Volet4_Bdstructuration\\R\\Alignement\\align2.txt")
...
try=import.fasta(seqalign,aa.to.upper=TRUE, gap.to.dash=TRUE)
