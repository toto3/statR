...
#info sur les objets
class(x)# class (type de donne̩s) :numeric,logical,integer,real,complex,string,raw
...
#sort=tri
#rank=le rang
#order= indice de permutaiton pour ̻tre tri̩
...
#array:multy dimension object. La dimension des ajust̩ par la function 
...
#2.11 Lists :::::::::::::================================
#une list est un bundle de vecteur de diff̩rent type et de diff longeur
...
# 3.1.1 Trees====
#package.ape::class.phylo         :utile pour garder les m̩tadonn̩es
...
#The class ape.phylo====
#edge        :2 col matrix repr̩sentant les branche de l'arbre
...
# A=1000 G=0100 C=0010 T=0001  facon de cod̩ les lettres
...
#all.equal() test si 2 obj sont approximativement ̩gal
#phylo.diff()
